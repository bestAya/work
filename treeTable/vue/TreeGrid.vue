  ...
  <el-table
    ...
    <el-table-column v-for="(column, index) in columns" :key="column.dataIndex"
      ...
      <template slot-scope="scope">
        ...
        <button class="button is-outlined is-primary is-small bnu" v-if="toggleIconShow(index,scope.row)" @click="toggle(scope.$index)">
    ...
    <el-table-column label="操作" v-if="treeType === 'normal'" width="260">
      <template slot-scope="scope">
        <el-button-group>
          ...
          <el-button type="primary" icon="el-icon-share" @click="handleDelete(scope.row)"></el-button>
          <el-button type="primary" icon="el-icon-delete" @click="handleadd(scope.row)"></el-button>
        </el-button-group>
      </template>
    </el-table-column>
  </el-table>
